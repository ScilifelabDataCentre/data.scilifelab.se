...
Archaeological findings, such as specimens, clay artifacts, jewellery, and other remnants, were traditionally the only way to study ancient cultures, and how humans expanded in a region. In recent decades, ancient DNA (aDNA) has expanded and enhanced our knowledge of human history. Today, DNA research is an important tool in both the natural (e.g. medicine and health) and social sciences (e.g. archaeology and linguistics).
