...
<video autoplay loop muted playsinline class="img-fluid">
  <source src="/media/open_science/resources.mp4" type="video/mp4">
  A looping animation showing scenes from a wet lab.
</video>

Welcome to our Open Science Resources page.
Here, you’ll find a collection of resources designed to help you integrate
Open Science and FAIR principles into your work.

## SciLifeLab Resources {#scilifelab-resources}
...
- Open Access Checklist (in development)
- Open Data Checklist (not started)
- Software Citation Checklist (in development)
...
<div class="row text-center justify-content-center align-items-center">
  <div class="col-6 col-sm-4 col-md-3 col-lg-2">
    <img src="/img/open_science/resources/fair_aware.png" class="img-fluid mb-3" alt="FAIR Aware logo">
  </div>
  <div class="col-6 col-sm-4 col-md-3 col-lg-2">
    <img src="/img/open_science/resources/eu_commission.png" class="img-fluid mb-3" alt="EU Commission logo">
  </div>
  <div class="col-6 col-sm-4 col-md-3 col-lg-2">
    <img src="/img/open_science/resources/vetenskapsrådet.png" class="img-fluid mb-3" alt="Vetenskapsrådet logo">
  </div>
  <div class="col-6 col-sm-4 col-md-3 col-lg-2">
    <img src="/img/open_science/resources/unesco.png" class="img-fluid mb-3" alt="UNESCO logo">
  </div>
  <div class="col-6 col-sm-4 col-md-3 col-lg-2">
    <img src="/img/open_science/resources/plan_s.png" class="img-fluid mb-3" alt="Plan-S logo">
  </div>
</div>
